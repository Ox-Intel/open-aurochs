...
class TestCreateSource(EventTestCase):
    def test_endpoint(self):
        self.assertEqual(Source.objects.count(), 0)
        data = {
            "event_type": "create_source",
        ...
        # 'username': 'zl2E6PrORKYwhVPfmepA50GGOlXzVQrEwHhudh0e0QPmB5beAz7dT6fw6b
