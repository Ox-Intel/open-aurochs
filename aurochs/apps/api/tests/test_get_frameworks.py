...
class TestGetFrameworks(EventTestCase):
    def test_endpoint(self):
        f = Factory.framework(user=self.user)
        f2 = Factory.framework(user=self.user)
        data = {
            "event_type": "get_frameworks",
        }
        ...
        self.assertEqual(obj_data["criteria"], [])
        # "criteria_hash": "cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36
        # self.assertEqual(obj_data["criteria_hash"], f2.criteria_hash)
        # "deleted": false,

        # "deleted_at": null,

        # "subtitle": "Early.",
        self.assertEqual(obj_data["subtitle"], f2.subtitle)
        # "id": 1,
        self.assertEqual(obj_data["id"], f2.ox_id)
        # "modified_at": "2022-04-12T19:18:30.443Z",
        # "modified_at_ms": 1649791110443.849,
        # "modified_by": null,

        # "name": "R\\u2764\\ud83c\\udf81\\ud83d\\udc8cF\\u2642\\ud83c\\udfa7\\ud83c\\udf31Dl",
        self.assertEqual(obj_data["name"], f2.name)
