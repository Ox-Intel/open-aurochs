...
class TestCreateFramework(EventTestCase):
    def test_endpoint(self):
        ...
        # "criteria_hash": "cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83
        ...
        # 'username': 'zl2E6PrORKYwhVPfmepA50GGOlXzVQrEwHhudh0e0QPmB5beAz7dT6fw6bGPZ1o
    ...
    def test_long_names(self):
        ...
        data = {
            "event_type": "create_framework",
            "name": Factory.rand_text(words=200),
            "subtitle": Factory.rand_text(words=200),
        }
    ...
    def test_create_also_subscribes(self):
        ...
        self.assertEqual(os.object_id, f.id)
